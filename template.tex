...
$if(education.honour)$ $education.honour$$endif$\\
$if(education.goal)$ $education.goal$$endif$\\[.14cm]
$endfor$
$endif$
...
$for(experience)$
  ...
  $if(experience.description)$\\\emph{$experience.description$}$endif$
  $if(experience.time)$ \ifthenelse{\equal{$lang$}{fr}}{Durée:}{Duration:} $experience.time$ $endif$\\[.14cm]
$endfor$
$endif$
...
\begin{enumerate}[leftmargin=0cm]
  ...
  \item{
  $for(references.author)$
  \ifthenelse{\equal{$references.author.family$}{Brice}}{\textbf{$references.author.family$ \fl{$references.author.given$.}}}{$references.author.family$ \fl{$references.author.given$.}}.,
