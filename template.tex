...
\item{
  ...
  $for(talks.conference)$
    $talks.conference.date$. $talks.conference.name$. $talks.conference.where$.
  $endfor$
...
$for(experience)$
  \note{$experience.years$} $experience.job$, \textsc{$experience.employer$}
...
\noindent
$for(teaching)$
  \note{$teaching.years$}$teaching.institute$ ($teaching.time$) \\
...
\noindent
$for(implication)$
  \note{$implication.years$}$implication.institute$ \\
